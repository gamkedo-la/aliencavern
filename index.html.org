...
//  var ridgeRockRightPic = document.createElement("img");
 ...
 // var canvas, canvasContext; 
  ...
  function debug() {
    //console.log("playerSpeedX = " + playerSpeedX);
  }
  ...
  function playerMove() {
   if(playerOnGround) {
    ...
    if(playerSpeedY < 0 && isBrickAtPixelCoord(playerX,playerY-player_RADIUS) == 1) {
    ...
    if(playerSpeedX < 0 && isBrickAtPixelCoord(playerX-player_RADIUS,playerY) == 1) {
    ...
    for(var eachCol=cameraLeftMostCol; eachCol<cameraRightMostCol; eachCol++) {
      for(var eachRow=cameraTopMostRow; eachRow<cameraBottomMostRow; eachRow++) {
        ...
        if( isBrickAtTileCoord(eachCol, eachRow) ) {
          ...
          canvasContext.drawImage(wallRockLeftPic,brickLeftEdgeX,brickTopEdgeY);
//            colorRect(brickLeftEdgeX, brickTopEdgeY,
//                   BRICK_W - BRICK_GAP, BRICK_H - BRICK_GAP, 'brown' );
